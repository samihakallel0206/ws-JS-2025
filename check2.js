...
// var maChaine = "Bonjour!";  !ruojnoB

// console.log(inverserChaine("Hello on est entrain d'apprendre le JS"));
// 2---------------------------------------------------------------
...
// var x = nmbreCar("Hello on est entrain d'apprendre le JS") + 10;
// console.log(x);
// 3----------------------------------------------

// bonjour je suis entrain de faire du dev web : Input argument
// Bonjour Je Suis Entrain De Faire Du Dev Web : Output  return
...
// console.log(majMot("bonjour js première"));
...
// console.log(sumArrayFor([4, 7, 8, 2]));
//3-------------------------------------------------------------
// tab = [10, 4, 7, 1, 8, -4, 3];
// Filtrer le tableau : implémentez une fonction qui filtre les éléments d’un tableau en fonction d’une condition donnée.
// la condition : les nombre paires
...
function premier(n) {
  // n est ce que divisible par 2 n%2 === 0?
  // n est ce que divisible par 3 n%3 === 0?
  // n est ce que divisible par 4 n % 4 === 0 ?
  //   .
  //   .
  //   .
  // n est ce que divisible par n - 1 n % n - 1 === 0 ?
